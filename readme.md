# p-state [![Build Status](https://github.com/sindresorhus/p-state/workflows/CI/badge.svg?branch=master)](https://github.com/sindresorhus/p-state/actions?query=branch%3Amaster+workflow%3ACI)
